    ...
    return (
      <>
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-300 text-sm">
            Your payment is being processed. Your wallet balance will be updated once confirmed.
          </p>
        </div>
        <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/10 px-6 py-4 text-sm text-yellow-300 space-y-1">
          <p>○ Payment processing</p>
          <p className="text-gray-400">○ Wallet update pending</p>
        </div>
        <Button asChild className="w-full">
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-300 text-sm">
          Your payment was successful. Your GBP balance has been updated and
          is ready to use for transfers.
        </p>
      </div>
      <div className="rounded-xl border border-green-500/30 bg-green-500/10 px-6 py-4 text-sm text-green-300 space-y-1">
        <p>✓ Payment received</p>
        <p>✓ Wallet balance updated</p>
      </div>
      <div className="flex flex-col gap-3">
        <Button asChild className="w-full">
          <Link href="/">Send a transfer</Link>
        </Button>
        <Button asChild variant="outline" className="w-full border-white/20 text-white hover:bg-white/10">
          <Link href="/topup">Top up again</Link>
        </Button>
      </div>
    </>
  );
